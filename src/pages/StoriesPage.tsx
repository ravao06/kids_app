...
const fallbackStories = [
  {
    story: "Il était une fois un petit chat nommé Minou qui vivait dans une forêt enchantée. Un jour, alors qu'il explorait les alentours, il trouva une clé dorée brillante près d'un vieux chêne. Que devrait faire Minou avec cette clé mystérieuse ?",
    choices: [
  ...
  {
    story: "Dans un royaume lointain vivait une petite princesse qui s'ennuyait terriblement dans son château. Un matin, elle découvrit un passage secret derrière sa bibliothèque. Le passage semblait mener profondément sous le château. Que devrait faire la princesse ?",
    choices: [
  ...
  {
    story: "Sur une planète lointaine, un petit robot nommé Beep s'était perdu lors d'une tempête de poussière. Quand la tempête se calma, Beep aperçut trois chemins différents. Lequel devrait-il prendre ?",
    choices: [
